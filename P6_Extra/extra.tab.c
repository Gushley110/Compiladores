...
#line 120 "extra.tab.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "extra.tab.h".  */
#ifndef YY_YY_EXTRA_TAB_H_INCLUDED
# define YY_YY_EXTRA_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#line 184 "extra.tab.c" /* yacc.c:355  */
};
...
#endif /* !YY_YY_EXTRA_TAB_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 201 "extra.tab.c" /* yacc.c:358  */
...
static const yytype_uint16 yyrline[] =
{
     ...
     224,   255,   256,   257,   258,   265,   270,   275,   280,   302,
     317,   332,   348,   362,   376,   392,   406,   420,   439,   453,
     467,   484,   498,   511,   525,   540,   555,   565,   575,   588,
     601,   616,   626,   636,   649,   668,   687,   708,   729,   759,
     780,   805,   806,   807,   808,   809,   814,   815,   816,   817,
     818,   819,   820,   821,   822,   823,   824,   829,   830,   831,
     835,   836,   837,   838,   839,   853,   854,   855,   856,   857,
     858,   863,   864
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 94 "extra.y" /* yacc.c:1646  */
    {imprimirTabla();}
#line 1467 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 95 "extra.y" /* yacc.c:1646  */
    {printf("\n");}
#line 1473 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 96 "extra.y" /* yacc.c:1646  */
    {printf("res entero-%d-\n",(yyvsp[-1].entero));}
#line 1479 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 97 "extra.y" /* yacc.c:1646  */
    {printf("res decimal -%f-\n",(yyvsp[-1].decimal));}
#line 1485 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 98 "extra.y" /* yacc.c:1646  */
    {printf("res string-%s-\n",(yyvsp[-1].palabra));}
#line 1491 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 104 "extra.y" /* yacc.c:1646  */
    {
...
#line 1504 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 112 "extra.y" /* yacc.c:1646  */
    {
    if(existeSimbolo((yyvsp[0].palabra)))
        printf("El símbolo ya existe\n");
    else {
...
#line 1517 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 120 "extra.y" /* yacc.c:1646  */
    {
    if(existeSimbolo((yyvsp[0].palabra)))
        printf("El símbolo ya existe\n");
    else {
...
#line 1530 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 128 "extra.y" /* yacc.c:1646  */
    {
    printf("Crea arreglo de tamaño %d\n", (yyvsp[-1].entero));
...
#line 1546 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 140 "extra.y" /* yacc.c:1646  */
    {
...
#line 1568 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 157 "extra.y" /* yacc.c:1646  */
    {
    if(existeSimbolo((yyvsp[-2].palabra)))
        printf("El símbolo ya existe\n");
    else {
...
#line 1590 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 174 "extra.y" /* yacc.c:1646  */
    {
    if ( existeSimbolo((yyvsp[-2].palabra)) )
        printf("El símbolo ya existe\n");
    else {
...
#line 1612 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 191 "extra.y" /* yacc.c:1646  */
    {
...
#line 1650 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 224 "extra.y" /* yacc.c:1646  */
    {
    if ( !existeSimbolo((yyvsp[-2].palabra)) )
...
#line 1686 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 255 "extra.y" /* yacc.c:1646  */
    { printf("Nombre de variable inválido, debe empezar por alguna letra\n"); }
#line 1692 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 256 "extra.y" /* yacc.c:1646  */
    { printf("Nombre de variable inválido, debe empezar por alguna letra\n"); }
#line 1698 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 257 "extra.y" /* yacc.c:1646  */
    { printf("Nombre de variable inválido, debe empezar por alguna letra\n"); }
#line 1704 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 258 "extra.y" /* yacc.c:1646  */
    {
...
#line 1715 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 265 "extra.y" /* yacc.c:1646  */
    {
    (yyval.dato).tipo = NUMBER_;
    (yyval.dato).numero = (yyvsp[0].entero);
    printf("expr: expr_entera\n");
                 }
#line 1725 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 270 "extra.y" /* yacc.c:1646  */
    {
    (yyval.dato).tipo = NUMBER_;
    (yyval.dato).numero = (yyvsp[0].decimal);
    printf("expr: expr_decimal\n");
              }
#line 1735 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 275 "extra.y" /* yacc.c:1646  */
    {
    (yyval.dato).tipo = STRING_;
    (yyval.dato).palabra = (yyvsp[0].palabra);
    printf("expr: expr_string\n");
             }
#line 1745 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 280 "extra.y" /* yacc.c:1646  */
    {
...
#line 1772 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 302 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
...
#line 1792 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 317 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
        (yyval.dato).numero = (yyvsp[-2].entero)-(yyvsp[0].dato).numero;
...
#line 1812 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 332 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
...
#line 1833 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 348 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
        (yyval.dato).numero = (yyvsp[-2].entero)*(yyvsp[0].dato).numero;
...
#line 1852 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 33:
#line 362 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
...
#line 1871 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 376 "extra.y" /* yacc.c:1646  */
    {
...
#line 1892 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 392 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
...
#line 1911 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 406 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
        (yyval.dato).numero = (yyvsp[-2].decimal)-(yyvsp[0].dato).numero;
...
#line 1930 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 37:
#line 420 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
        if((yyvsp[0].dato).numero == 0.0) {
...
#line 1954 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 439 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
            (yyval.dato).numero = (yyvsp[-2].decimal)*(yyvsp[0].dato).numero;
...
#line 1973 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 453 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case NUMBER_:
...
#line 1992 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 467 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[-1].dato).tipo) {
    case NUMBER_:
...
#line 2014 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 41:
#line 484 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case STRING_:
...
#line 2033 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 498 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case STRING_:
...
#line 2051 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 511 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case STRING_:
...
#line 2070 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 525 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case STRING_:
        (yyval.dato).tipo = UNDEF_;
...
#line 2090 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 540 "extra.y" /* yacc.c:1646  */
    {
    switch ((yyvsp[0].dato).tipo) {
    case STRING_:
        (yyval.dato).tipo = UNDEF_;
...
#line 2110 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 555 "extra.y" /* yacc.c:1646  */
    {
...
#line 2125 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 565 "extra.y" /* yacc.c:1646  */
    {
...
#line 2140 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 48:
#line 575 "extra.y" /* yacc.c:1646  */
    {
...
#line 2158 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 49:
#line 588 "extra.y" /* yacc.c:1646  */
    {
    if ( (yyvsp[-2].dato).tipo == NUMBER_ && (yyvsp[0].dato).tipo == NUMBER_ ) {
        (yyval.dato).tipo = NUMBER_;
        (yyval.dato).numero = (yyvsp[-2].dato).numero - (yyvsp[0].dato).numero;
...
#line 2176 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 601 "extra.y" /* yacc.c:1646  */
    {
    if ( (yyvsp[-2].dato).tipo == NUMBER_ && (yyvsp[0].dato).tipo == NUMBER_ ) {
        (yyval.dato).tipo = NUMBER_;
        if ( (yyvsp[0].dato).numero == 0.0 ) {
...
#line 2196 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 51:
#line 616 "extra.y" /* yacc.c:1646  */
    {
    if ( (yyvsp[-2].dato).tipo == NUMBER_ && (yyvsp[0].dato).tipo == NUMBER_ ) {
        (yyval.dato).tipo = NUMBER_;
            (yyval.dato).numero = (yyvsp[-2].dato).numero * (yyvsp[0].dato).numero;
...
#line 2211 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 52:
#line 626 "extra.y" /* yacc.c:1646  */
    {
    if ( (yyvsp[-2].dato).tipo == NUMBER_ && (yyvsp[0].dato).tipo == NUMBER_ ) {
        (yyval.dato).tipo = NUMBER_;
...
#line 2226 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 53:
#line 636 "extra.y" /* yacc.c:1646  */
    {
...
#line 2244 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 54:
#line 649 "extra.y" /* yacc.c:1646  */
    {
    if ( (yyvsp[-3].dato).tipo == UNDEF_ || (yyvsp[-1].dato).tipo == UNDEF_ ) {
        printf("expr inválida\n");
        (yyval.dato).tipo = UNDEF_;
...
#line 2268 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 55:
#line 668 "extra.y" /* yacc.c:1646  */
    {
    if (!existeSimbolo((yyvsp[0].palabra))) {
        printf("no existe el símbolo, expr inválida\n");
        (yyval.dato).tipo = UNDEF_;
...
#line 2292 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 56:
#line 687 "extra.y" /* yacc.c:1646  */
    {
    if (!existeSimbolo((yyvsp[-2].palabra))) {
        printf("no existe el símbolo, expr inválida\n");
        (yyval.dato).tipo = UNDEF_;
...
#line 2318 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 57:
#line 708 "extra.y" /* yacc.c:1646  */
    {
    if (!existeSimbolo((yyvsp[-2].palabra))) {
        printf("no existe el símbolo, expr inválida\n");
        (yyval.dato).tipo = UNDEF_;
...
#line 2344 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 58:
#line 729 "extra.y" /* yacc.c:1646  */
    {
    if (!existeSimbolo((yyvsp[-2].palabra))) {
        printf("no existe el símbolo, expr inválida\n");
        (yyval.dato).tipo = UNDEF_;
...
#line 2379 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 59:
#line 759 "extra.y" /* yacc.c:1646  */
    {
    if (!existeSimbolo((yyvsp[-2].palabra))) {
        printf("no existe el símbolo, expr inválida\n");
        (yyval.dato).tipo = UNDEF_;
...
#line 2405 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 60:
#line 780 "extra.y" /* yacc.c:1646  */
    {
    if (!existeSimbolo((yyvsp[-2].palabra))) {
        printf("no existe el símbolo, expr inválida\n");
        (yyval.dato).tipo = UNDEF_;
...
#line 2431 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 61:
#line 805 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[0].decimal); }
#line 2437 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 62:
#line 806 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].decimal) + (yyvsp[0].decimal);    }
#line 2443 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 63:
#line 807 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].decimal) - (yyvsp[0].decimal);    }
#line 2449 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 64:
#line 808 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].decimal) * (yyvsp[0].decimal);    }
#line 2455 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 65:
#line 809 "extra.y" /* yacc.c:1646  */
    {
    for(int i = 1; i<(int)(yyvsp[-1].decimal); i++)
        (yyvsp[-3].decimal) *= (yyvsp[-3].decimal);
    (yyval.decimal) = (int)(yyvsp[-3].decimal);
}
#line 2465 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 66:
#line 814 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (int)(yyvsp[-2].decimal) % (int)(yyvsp[0].decimal);    }
#line 2471 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 67:
#line 815 "extra.y" /* yacc.c:1646  */
...
#line 2477 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 68:
#line 816 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].entero) + (yyvsp[0].decimal);    }
#line 2483 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 69:
#line 817 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].entero) - (yyvsp[0].decimal);    }
#line 2489 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 70:
#line 818 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].entero) * (yyvsp[0].decimal);    }
#line 2495 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 71:
#line 819 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (int)(yyvsp[-2].entero) % (int)(yyvsp[0].decimal);    }
#line 2501 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 72:
#line 820 "extra.y" /* yacc.c:1646  */
    { if( (yyvsp[0].decimal) == 0.0f ) { printf("El denominador no debe ser cero\n"); (yyval.decimal)=0; } else { (yyval.decimal) = (yyvsp[-2].entero) / (yyvsp[0].decimal); } }
#line 2507 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 73:
#line 821 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].decimal) + (yyvsp[0].entero);    }
#line 2513 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 74:
#line 822 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].decimal) - (yyvsp[0].entero);    }
#line 2519 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 75:
#line 823 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (yyvsp[-2].decimal) * (yyvsp[0].entero);    }
#line 2525 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 76:
#line 824 "extra.y" /* yacc.c:1646  */
    {
    for(int i = 1; i<(yyvsp[-1].entero); i++)
        (yyvsp[-3].decimal) *= (yyvsp[-3].decimal);
    (yyval.decimal) = (int)(yyvsp[-3].decimal);
}
#line 2535 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 77:
#line 829 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = (int)(yyvsp[-2].decimal) % (int)(yyvsp[0].entero);    }
#line 2541 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 78:
#line 830 "extra.y" /* yacc.c:1646  */
...
#line 2547 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 79:
#line 831 "extra.y" /* yacc.c:1646  */
    { (yyval.decimal) = -(yyvsp[0].decimal); }
#line 2553 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 80:
#line 835 "extra.y" /* yacc.c:1646  */
    {  (yyval.palabra) = (yyvsp[-1].palabra); }
#line 2559 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 81:
#line 836 "extra.y" /* yacc.c:1646  */
    { (yyval.palabra) = sumarCadena((yyvsp[-2].palabra),(yyvsp[0].palabra)); }
#line 2565 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 82:
#line 837 "extra.y" /* yacc.c:1646  */
    { (yyval.palabra) = restarCadena((yyvsp[-2].palabra),(yyvsp[0].palabra)); }
#line 2571 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 83:
#line 838 "extra.y" /* yacc.c:1646  */
    {  (yyval.palabra) = divCadena((yyvsp[-3].palabra),(yyvsp[-1].palabra));  }
#line 2577 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 84:
#line 839 "extra.y" /* yacc.c:1646  */
    {
    if( (yyvsp[-1].entero) < 0 ) {
...
#line 2593 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 85:
#line 853 "extra.y" /* yacc.c:1646  */
    { (yyval.entero) = (yyvsp[0].entero); }
#line 2599 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 86:
#line 854 "extra.y" /* yacc.c:1646  */
    { (yyval.entero) = (yyvsp[-2].entero) + (yyvsp[0].entero); }
#line 2605 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 87:
#line 855 "extra.y" /* yacc.c:1646  */
    { (yyval.entero) = (yyvsp[-2].entero) - (yyvsp[0].entero); }
#line 2611 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 88:
#line 856 "extra.y" /* yacc.c:1646  */
    { (yyval.entero) = (yyvsp[-2].entero) * (yyvsp[0].entero); }
#line 2617 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 89:
#line 857 "extra.y" /* yacc.c:1646  */
    { (yyval.entero) = (yyvsp[-2].entero) % (yyvsp[0].entero); }
#line 2623 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 90:
#line 858 "extra.y" /* yacc.c:1646  */
    {
    for(int i = 1; i<(yyvsp[-1].entero); i++)
        (yyvsp[-3].entero) *= (yyvsp[-3].entero);
    (yyval.entero) = (yyvsp[-3].entero);
}
#line 2633 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 91:
#line 863 "extra.y" /* yacc.c:1646  */
    { if((yyvsp[0].entero) == 0)  { printf("El denominador no debe ser cero\n"); (yyval.entero)=0; } else { (yyval.entero) = (yyvsp[-2].entero) / (yyvsp[0].entero); }    }
#line 2639 "extra.tab.c" /* yacc.c:1646  */
    break;

  case 92:
#line 864 "extra.y" /* yacc.c:1646  */
    { (yyval.entero) = -(yyvsp[0].entero); }
#line 2645 "extra.tab.c" /* yacc.c:1646  */
    break;


#line 2649 "extra.tab.c" /* yacc.c:1646  */
      default: break;
    }
