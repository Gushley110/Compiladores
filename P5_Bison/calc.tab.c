...
{
  "$end", "error", "$undefined", "ENTERO", "POW", "DIV", "DECIMAL",
  "CADENA", "'+'", "'-'", "'*'", "'/'", "'\\n'", "$accept", "input",
  "line", "exp_entera", "exp_decimal", "exp_cadena", YY_NULLPTR
};
#endif
...
{
      -8,     0,    -8,    -8,    -8,    -8,     1,    -8,    -8,    11,
      16,    -7,     3,     1,     1,     1,     1,    -8,     5,     5,
      -8,    18,    18,    -8,     3,     3,    -8,    -8,    17,    -8,
      -8,    -8
};
...
{
       2,     0,     1,     8,    14,    17,     0,     4,     3,     0,
       0,     0,     9,     0,     0,     0,     0,     5,     0,     0,
       6,     0,     0,     7,    10,    11,    12,    13,    15,    16,
      18,    19
};
...
{
       2,    21,    22,     3,     3,    23,     4,     5,    12,     6,
       6,     4,     7,    15,    16,    24,    25,    26,    27,    13,
      14,    15,    16,    17,    18,     5,    19,    19,    20,     0,
      28,    29,     0,     0,    30,    31
};

static const yytype_int8 yycheck[] =
{
       0,     8,     9,     3,     3,    12,     6,     7,     6,     9,
       9,     6,    12,    10,    11,    13,    14,    15,    16,     8,
       9,    10,    11,    12,     8,     7,    10,    10,    12,    -1,
      18,    19,    -1,    -1,    21,    22
};
...
{
       0,    14,     0,     3,     6,     7,     9,    12,    15,    16,
      17,    18,    16,     8,     9,    10,    11,    12,     8,    10,
      12,     8,     9,    12,    16,    16,    16,    16,    17,    17,
      18,    18
};
...
#line 60 "calc.y" /* yacc.c:1646  */
    {(yyval.cadena) = strconcat((yyvsp[-2].cadena),(yyvsp[0].cadena));}
#line 1312 "calc.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 61 "calc.y" /* yacc.c:1646  */
    {(yyval.cadena) = strsubstract((yyvsp[-2].cadena),(yyvsp[0].cadena));}
